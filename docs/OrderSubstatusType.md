...
* `POSTPAID_FAILED` (value: `"POSTPAID_FAILED"`)

* `INCORRECT_PERSONAL_DATA` (value: `"INCORRECT_PERSONAL_DATA"`)

* `CUSTOMS_FAILED_MARKET` (value: `"CUSTOMS_FAILED_MARKET"`)

* `CUSTOMS_FAILED_USER_COMMERCIAL_ITEMS` (value: `"CUSTOMS_FAILED_USER_COMMERCIAL_ITEMS"`)

* `CUSTOMS_FAILED_USER_DUTY_NOT_PAID` (value: `"CUSTOMS_FAILED_USER_DUTY_NOT_PAID"`)

* `CUSTOMS_FAILED_USER_INVALID_PERSONAL_DATA` (value: `"CUSTOMS_FAILED_USER_INVALID_PERSONAL_DATA"`)

* `CUSTOMS_FAILED_USER_ADDITIONAL_DATA_NOT_PROVIDED` (value: `"CUSTOMS_FAILED_USER_ADDITIONAL_DATA_NOT_PROVIDED"`)

* `AWAIT_PAYMENT_AFTER_DELIVERY` (value: `"AWAIT_PAYMENT_AFTER_DELIVERY"`)

* `AWAIT_USER_STEAM_FAST_URL` (value: `"AWAIT_USER_STEAM_FAST_URL"`)

* `USER_IDENTIFICATION_MISMATCH` (value: `"USER_IDENTIFICATION_MISMATCH"`)

* `PURCHASE_GROUP_THRESHOLD_NOT_REACHED_CANCELLED` (value: `"PURCHASE_GROUP_THRESHOLD_NOT_REACHED_CANCELLED"`)
