...
------------ | ------------- | ------------- | -------------
**Skus** | [**[]UpdateStockDTO**](UpdateStockDTO.md) | Данные об остатках товаров.  В рамках одного запроса все значения &#x60;sku&#x60; должны быть уникальными. Не допускается передача двух объектов с одинаковым &#x60;sku&#x60;.  | 
