...
**ValueId** | Pointer to **int64** | Идентификатор значения.  - Обязательно указывайте идентификатор, если передаете значение из перечня допустимых значений, полученного от Маркета. - Не указывайте для собственных значений. - Только для характеристик типа &#x60;ENUM&#x60;.  | [optional] 
**Value** | Pointer to **string** | Значение.  Для характеристик типа &#x60;ENUM&#x60; передавайте: - вместе с &#x60;valueId&#x60;, если значение берете из справочника; - без &#x60;valueId&#x60;, если значение собственное.  | [optional] 
