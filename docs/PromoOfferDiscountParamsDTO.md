...
**MaxPromoPrice** | Pointer to **int64** | Максимально возможная цена для участия в акции. Если значение не заполнено, ограничение отсутствует.  Указывается в рублях.  | [optional] 
