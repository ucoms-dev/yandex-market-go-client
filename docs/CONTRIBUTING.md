...
- `generate-go-client.sh` preserves `api/` after generation. The checked-in
  spec must stay in upstream ref-based form (`api/openapi.yaml` plus `paths/`
  and `components/`), not as a bundled `openapi.yaml` generated by
  `openapi-generator`.
