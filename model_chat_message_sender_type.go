...
// ChatMessageSenderType Кто отправил сообщение:  * `PARTNER` — магазин. * `CUSTOMER` — покупатель. * `MARKET` — Маркет ([автоматическое сообщение](*market-notification)). * `SUPPORT` — сотрудник службы поддержки Маркета.
