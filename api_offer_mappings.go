...
// OfferMappingEntriesService describes the interface for executing offer mapping
// entries requests. All API services providing the
// GetOfferMappingEntriesExecute method satisfy this interface.
type OfferMappingEntriesService interface {
	GetOfferMappingEntriesExecute(r ApiGetOfferMappingEntriesRequest) (*GetOfferMappingEntriesResponse, *http.Response, error)
}

type ApiGetOfferMappingEntriesRequest struct {
	ctx          context.Context
	ApiService   OfferMappingEntriesService
	campaignId   int64
	offerId      *[]string
	shopSku      *[]string
