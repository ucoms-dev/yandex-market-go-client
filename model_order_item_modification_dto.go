...
type OrderItemModificationDTO struct {
	// Идентификатор товара в рамках заказа.  Получить идентификатор можно с помощью метода:  * [POST v1/businesses/{businessId}/orders](../../reference/orders/getBusinessOrders.md).  Обязательный параметр.
	Id int64 `json:"id"`
...
func (v *NullableOrderItemModificationDTO) Unset() {
	var zero *OrderItemModificationDTO
	v.value = zero
	v.isSet = false
}
