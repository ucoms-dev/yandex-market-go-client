...
type _CreateChatResponse CreateChatResponse
...
func (o *CreateChatResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateChatResponse := _CreateChatResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateChatResponse)

	if err != nil {
		return err
	}

	*o = CreateChatResponse(varCreateChatResponse)
