...
type _ApiNotFoundErrorResponse ApiNotFoundErrorResponse
...
func (o *ApiNotFoundErrorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varApiNotFoundErrorResponse := _ApiNotFoundErrorResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiNotFoundErrorResponse)

	if err != nil {
		return err
	}

	*o = ApiNotFoundErrorResponse(varApiNotFoundErrorResponse)
