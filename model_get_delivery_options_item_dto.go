...
// checks if the GetDeliveryOptionsItemDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeliveryOptionsItemDTO{}

// GetDeliveryOptionsItemDTO Товар, для которого нужно вернуть варианты доставки.
type GetDeliveryOptionsItemDTO struct {
	...
	// Идентификатор фулфилмент-склада Маркета.  Передайте этот параметр, чтобы вернулись варианты доставки для указанного склада. Иначе Маркет сам выберет склад.  [Как узнать остатки товаров на складах](../../reference/stocks/getStocks.md)
	WarehouseId *int64 `json:"warehouseId,omitempty"`
}

type _GetDeliveryOptionsItemDTO GetDeliveryOptionsItemDTO
...
func NewGetDeliveryOptionsItemDTO(offerId string, count int32) *GetDeliveryOptionsItemDTO {
	this := GetDeliveryOptionsItemDTO{}
...
func (o GetDeliveryOptionsItemDTO) MarshalJSON() ([]byte, error) {
...
func (o GetDeliveryOptionsItemDTO) ToMap() (map[string]interface{}, error) {
...
func (o *GetDeliveryOptionsItemDTO) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDeliveryOptionsItemDTO := _GetDeliveryOptionsItemDTO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDeliveryOptionsItemDTO)

	if err != nil {
		return err
	}

	*o = GetDeliveryOptionsItemDTO(varGetDeliveryOptionsItemDTO)

	return err
}

type NullableGetDeliveryOptionsItemDTO struct {
	value *GetDeliveryOptionsItemDTO
	isSet bool
}

func (v NullableGetDeliveryOptionsItemDTO) Get() *GetDeliveryOptionsItemDTO {
	return v.value
}

func (v *NullableGetDeliveryOptionsItemDTO) Set(val *GetDeliveryOptionsItemDTO) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeliveryOptionsItemDTO) IsSet() bool {
	return v.isSet
}
...
func NewNullableGetDeliveryOptionsItemDTO(val *GetDeliveryOptionsItemDTO) *NullableGetDeliveryOptionsItemDTO {
	return &NullableGetDeliveryOptionsItemDTO{value: val, isSet: true}
}

func (v NullableGetDeliveryOptionsItemDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeliveryOptionsItemDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
