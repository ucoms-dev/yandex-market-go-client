...
func (r FbyAPIDeleteGoodsFeedbackCommentRequest) SourceType(sourceType SourceType) FbyAPIDeleteGoodsFeedbackCommentRequest {
...
// Признак типа кабинета, от имени которого вызывается метод: {% if audience &#x3D;&#x3D; \&quot;partner\&quot; %}  - &#x60;SELLER&#x60; — продавец.  {% endif %}  - &#x60;ADVERTISER&#x60; — рекламодатель.  {% if audience &#x3D;&#x3D; \&quot;advertiser\&quot; %}  {% note info \&quot;Обязательно указывайте sourceType&#x3D;ADVERTISER в каждом запросе.\&quot; %}     {% endnote %}  {% endif %}
func (r FbyAPIGetGoodsFeedbackCommentsRequest) SourceType(sourceType SourceType) FbyAPIGetGoodsFeedbackCommentsRequest {
	r.sourceType = &sourceType
	return r
}
...
type FbyAPIGetGoodsFeedbacksUrbanadsRequest struct {
	ctx                             context.Context
	ApiService                      *FbyAPIService
	businessId                      int64
	pageToken                       *string
...
// Идентификатор страницы c результатами.  Если параметр не указан, возвращается первая страница.  Передавайте значение выходного параметра &#x60;nextPageToken&#x60;, полученное при последнем запросе.
func (r FbyAPIGetGoodsFeedbacksUrbanadsRequest) PageToken(pageToken string) FbyAPIGetGoodsFeedbacksUrbanadsRequest {
	r.pageToken = &pageToken
	return r
}

// {{ limit-param-description }}
func (r FbyAPIGetGoodsFeedbacksUrbanadsRequest) Limit(limit int32) FbyAPIGetGoodsFeedbacksUrbanadsRequest {
	r.limit = &limit
	return r
}

// Признак типа кабинета, от имени которого вызывается метод: {% if audience &#x3D;&#x3D; \&quot;partner\&quot; %}  - &#x60;SELLER&#x60; — продавец.  {% endif %}  - &#x60;ADVERTISER&#x60; — рекламодатель.  {% if audience &#x3D;&#x3D; \&quot;advertiser\&quot; %}  {% note info \&quot;Обязательно указывайте sourceType&#x3D;ADVERTISER в каждом запросе.\&quot; %}     {% endnote %}  {% endif %}
func (r FbyAPIGetGoodsFeedbacksUrbanadsRequest) SourceType(sourceType SourceType) FbyAPIGetGoodsFeedbacksUrbanadsRequest {
	r.sourceType = &sourceType
	return r
}

func (r FbyAPIGetGoodsFeedbacksUrbanadsRequest) GetGoodsFeedbackUrbanadsRequest(getGoodsFeedbackUrbanadsRequest GetGoodsFeedbackUrbanadsRequest) FbyAPIGetGoodsFeedbacksUrbanadsRequest {
	r.getGoodsFeedbackUrbanadsRequest = &getGoodsFeedbackUrbanadsRequest
	return r
}

func (r FbyAPIGetGoodsFeedbacksUrbanadsRequest) Execute() (*GetGoodsFeedbackUrbanadsResponse, *http.Response, error) {
...
{% include notitle [limit](../../_auto/method_limits/getGoodsFeedbacksUrbanads.md) %}
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param businessId Идентификатор кабинета.  {% if audience == \"partner\" %}  Чтобы его узнать, воспользуйтесь запросом [GET v2/campaigns](../../reference/campaigns/getCampaigns.md).  ℹ️ [Что такое кабинет и магазин на Маркете](https://yandex.ru/support/marketplace/account/introduction.html)  {% endif %}
	@return FbyAPIGetGoodsFeedbacksUrbanadsRequest
*/
func (a *FbyAPIService) GetGoodsFeedbacksUrbanads(ctx context.Context, businessId int64) FbyAPIGetGoodsFeedbacksUrbanadsRequest {
	return FbyAPIGetGoodsFeedbacksUrbanadsRequest{
		ApiService: a,
		ctx:        ctx,
		businessId: businessId,
...
func (a *FbyAPIService) GetGoodsFeedbacksUrbanadsExecute(r FbyAPIGetGoodsFeedbacksUrbanadsRequest) (*GetGoodsFeedbackUrbanadsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FbyAPIService.GetGoodsFeedbacksUrbanads")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Признак типа кабинета, от имени которого вызывается метод: {% if audience &#x3D;&#x3D; \&quot;partner\&quot; %}  - &#x60;SELLER&#x60; — продавец.  {% endif %}  - &#x60;ADVERTISER&#x60; — рекламодатель.  {% if audience &#x3D;&#x3D; \&quot;advertiser\&quot; %}  {% note info \&quot;Обязательно указывайте sourceType&#x3D;ADVERTISER в каждом запросе.\&quot; %}     {% endnote %}  {% endif %}
func (r FbyAPISkipGoodsFeedbacksReactionRequest) SourceType(sourceType SourceType) FbyAPISkipGoodsFeedbacksReactionRequest {
	r.sourceType = &sourceType
	return r
}
...
// Признак типа кабинета, от имени которого вызывается метод: {% if audience &#x3D;&#x3D; \&quot;partner\&quot; %}  - &#x60;SELLER&#x60; — продавец.  {% endif %}  - &#x60;ADVERTISER&#x60; — рекламодатель.  {% if audience &#x3D;&#x3D; \&quot;advertiser\&quot; %}  {% note info \&quot;Обязательно указывайте sourceType&#x3D;ADVERTISER в каждом запросе.\&quot; %}     {% endnote %}  {% endif %}
func (r FbyAPIUpdateGoodsFeedbackCommentRequest) SourceType(sourceType SourceType) FbyAPIUpdateGoodsFeedbackCommentRequest {
	r.sourceType = &sourceType
	return r
}
