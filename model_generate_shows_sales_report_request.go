...
// GenerateShowsSalesReportRequest Данные, необходимые для генерации отчета.  В запросе обязательно должен быть либо `businessId`, либо `campaignId`, но не оба сразу.
...
func (v *NullableGenerateShowsSalesReportRequest) Unset() {
	var zero *GenerateShowsSalesReportRequest
	v.value = zero
	v.isSet = false
}
