...
type _GetOrdersStatsResponse GetOrdersStatsResponse
...
func (o *GetOrdersStatsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetOrdersStatsResponse := _GetOrdersStatsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetOrdersStatsResponse)

	if err != nil {
		return err
	}

	*o = GetOrdersStatsResponse(varGetOrdersStatsResponse)
...
func (v *NullableGetOrdersStatsResponse) Unset() {
	var zero *GetOrdersStatsResponse
	v.value = zero
	v.isSet = false
}
