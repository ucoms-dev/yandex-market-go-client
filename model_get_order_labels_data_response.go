...
type _GetOrderLabelsDataResponse GetOrderLabelsDataResponse
...
func (o *GetOrderLabelsDataResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetOrderLabelsDataResponse := _GetOrderLabelsDataResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetOrderLabelsDataResponse)

	if err != nil {
		return err
	}

	*o = GetOrderLabelsDataResponse(varGetOrderLabelsDataResponse)
...
func (v *NullableGetOrderLabelsDataResponse) Unset() {
	var zero *GetOrderLabelsDataResponse
	v.value = zero
	v.isSet = false
}
