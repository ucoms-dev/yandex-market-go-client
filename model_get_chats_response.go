...
type _GetChatsResponse GetChatsResponse
...
func (o *GetChatsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetChatsResponse := _GetChatsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetChatsResponse)

	if err != nil {
		return err
	}

	*o = GetChatsResponse(varGetChatsResponse)
