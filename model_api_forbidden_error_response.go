...
type _ApiForbiddenErrorResponse ApiForbiddenErrorResponse
...
func (o *ApiForbiddenErrorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varApiForbiddenErrorResponse := _ApiForbiddenErrorResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiForbiddenErrorResponse)

	if err != nil {
		return err
	}

	*o = ApiForbiddenErrorResponse(varApiForbiddenErrorResponse)
...
func (v *NullableApiForbiddenErrorResponse) Unset() {
	var zero *ApiForbiddenErrorResponse
	v.value = zero
	v.isSet = false
}
